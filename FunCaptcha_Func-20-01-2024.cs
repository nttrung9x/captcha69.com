public string GetImgInstructions_By_CaptCha69_Com(string CauHoiFullText)
{
	...
	else if(CauHoiFullText.Contains("materialshapes-brickconecheckercube")){return "mat_brickcone_checkercube";}
	else if(CauHoiFullText.Contains("materialshapes-brickconecheckersphere")){return "mat_brickcone_checkersphere";}
	else if(CauHoiFullText.Contains("materialshapes-brickconestripecone")){return "mat_brickcone_stripecone";}
	else if(CauHoiFullText.Contains("materialshapes-brickcubestripeheart")){return "mat_brickcube_stripeheart";}
	else if(CauHoiFullText.Contains("materialshapes-brickcubestripesphere")){return "mat_brickcube_stripesphere";}
	else if(CauHoiFullText.Contains("materialshapes-brickheartstripeheart")){return "mat_brickheart_stripeheart";}
	else if(CauHoiFullText.Contains("materialshapes-brickspherecheckerheart")){return "mat_bricksphere_checkerheart";}
	else if(CauHoiFullText.Contains("materialshapes-checkerconecheckersphere")){return "mat_checkercone_checkersphere";}
	else if(CauHoiFullText.Contains("materialshapes-fuzzconebricksphere")){return "mat_fuzzcone_bricksphere";}
	else if(CauHoiFullText.Contains("materialshapes-fuzzcubecheckercube")){return "mat_fuzzcube_checkercube";}
	else if(CauHoiFullText.Contains("materialshapes-fuzzcubestripecube")){return "mat_fuzzcube_stripecube";}
	else if(CauHoiFullText.Contains("materialshapes-fuzzheartbrickheart")){return "mat_fuzzheart_brickheart";}
	else if(CauHoiFullText.Contains("materialshapes-fuzzheartstripeheart")){return "mat_fuzzheart_stripeheart";}
	else if(CauHoiFullText.Contains("materialshapes-fuzzspherestripecone")){return "mat_fuzzsphere_stripecone";}
	else if(CauHoiFullText.Contains("materialshapes-fuzzspherestripecube")){return "mat_fuzzsphere_stripecube";}
	else if(CauHoiFullText.Contains("materialshapes-stripeconecheckercube")){return "mat_stripecone_checkercube";}
	else if(CauHoiFullText.Contains("materialshapes-stripecubecheckercube")){return "mat_stripecube_checkercube";}
	else if(CauHoiFullText.Contains("materialshapes-stripecubecheckerheart")){return "mat_stripecube_checkerheart";}
	else if(CauHoiFullText.Contains("materialshapes-stripecubecheckersphere")){return "mat_stripecube_checkersphere";}
	else if(CauHoiFullText.Contains("materialshapes-stripeheartcheckercube")){return "mat_stripeheart_checkercube";}
	else if(CauHoiFullText.Contains("materialshapes-stripeshapecheckershape")){return "mat_stripeshape_checkershape";}
	else if(CauHoiFullText.Contains("materialshapes-stripeshapestripeshape")){return "mat_stripeshape_stripeshape";}
