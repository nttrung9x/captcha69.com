...
|	dice_14_revised	|	dicesum14		|
|	dice_4_revised	|	dicesum4		|
|	dice_slow_6_revised	|	dicesum6		|
|	dice_slow_7_revised	|	dicesum7		|
...
|	Pick the pig	|	pig		|
|	Pick the bee	|	bee		|
|	Pick the monkey	|	monkey		|
|	Pick the snake	|	snake		|
|	Pick the chicken	|	chicken		|
|	Pick the ladybug	|	ladybug		|
|	Pick the bread	|	bread		|
|	Pick the octopus	|	octopus		|
|	Pick the deer	|	deer		|
|	Pick the cow	|	cow		|
|	Pick the lobster	|	lobster		|
|	Pick the apple	|	apple		|
|	Pick the seal	|	seal		|
|	Pick the camel	|	camel		|
|	Pick the bear	|	bear		|
|	Pick the crab	|	crab		|
|	Pick the cat	|	cat		|
|	Pick the pig	|	pig		|
...
|	Pick the rabbit	|	rabbit		|
|	Pick the banana	|	banana		|
|	Pick the snail	|	snail		|
|	Pick the pizza	|	pizza		|
|	Pick the koala	|	koala		|
|	Pick the duck	|	duck		|
|	Pick the zebra	|	zebra		|
|	Pick the sheep	|	sheep		|
|	Pick the kangaroo	|	kangaroo		|
|	Pick the dog	|	dog		|
...
|	Pick the lion	|	lion		|
|	Pick the grapes	|	grapes		|
|	Pick the giraffe	|	giraffe		|
|	Pick the bat	|	bat		|
|	Pick the frog	|	frog		|
|	Pick the goat	|	goat		|
|	Pick the mouse	|	mouse		|
|	Pick the dolphin	|	dolphin		|
|	Pick the rhino	|	rhino		|
...
|	Pick the image of the brick cube and the striped heart	|	mat_brickcube_stripeheart		|
|	Pick the image of the brick cube and the striped sphere	|	mat_brickcube_stripesphere		|
|	Pick the image of the brick heart and the striped heart	|	mat_brickheart_stripeheart		|
|	Pick the image of the brick sphere and the checkered heart	|	mat_bricksphere_checkerheart		|
|	Pick the image of the checkered cone and the checkered sphere	|	mat_checkercone_checkersphere		|
|	Pick the image of the fuzzy cone and the brick sphere	|	mat_fuzzcone_bricksphere		|
|	Pick the image of the fuzzy cube and the checkered cube	|	mat_fuzzcube_checkercube		|
|	Pick the image of the fuzzy cube and the striped cube	|	mat_fuzzcube_stripecube		|
|	Pick the image of the fuzzy heart and the brick heart	|	mat_fuzzheart_brickheart		|
|	Pick the image of the fuzzy heart and the striped heart	|	mat_fuzzheart_stripeheart		|
|	Pick the image of the fuzzy sphere and the striped cone	|	mat_fuzzsphere_stripecone		|
|	Pick the image of the fuzzy sphere and the striped cube	|	mat_fuzzsphere_stripecube		|
|	Pick the image of the striped cone and the checkered cube	|	mat_stripecone_checkercube		|
|	Pick the image of the striped cube and the checkered cube	|	mat_stripecube_checkercube		|
|	Pick the image of the striped cube and the checkered heart	|	mat_stripecube_checkerheart		|
|	Pick the image of the striped cube and the checkered sphere	|	mat_stripecube_checkersphere		|
|	Pick the image of the striped heart and the checkered cube	|	mat_stripeheart_checkercube		|
|	Pick the image where the darts add up to 6	|	darts6		|
...
|	Use the arrows to move the character on the tiles which have the same icons as shown on the left	|	dance_floor		|
|	Use the Arrows to match the shadow of the objects shown on the left	|	extendedshadows		|
|	extendedshadowanimals	|	extendedshadows		|
...
|	Pick the image where the darts add up to 15	|	darts15		|
|	Pick the image where the darts add up to 13	|	darts13		|
|	Pick the alien	|	alien		|
|	Pick the anchor	|	anchor		|
|	Pick the aquarium	|	aquarium		|
|	Pick the ball	|	ball		|
|	Pick the bicycle	|	bicycle		|
|	Pick the boat	|	boat		|
|	Pick the calculator	|	calculator		|
|	Pick the camera	|	camera		|
|	Pick the car	|	car		|
|	Pick the cheese	|	cheese		|
|	Pick the computer	|	computer		|
|	Pick the couch	|	couch		|
|	Pick the crown	|	crown		|
|	Pick the fan	|	fan		|
|	Pick the fence	|	fence		|
|	Pick the fire	|	fire		|
|	Pick the flower	|	flower		|
|	Pick the glasses	|	glasses		|
|	Pick the helmet	|	helmet		|
|	Pick the hotdog	|	hotdog		|
|	Pick the key	|	key		|
|	Pick the lamp	|	lamp		|
|	Pick the money	|	money		|
|	Pick the mushroom	|	mushroom		|
|	Pick the pants	|	pants		|
|	Pick the pencil	|	pencil		|
|	Pick the printer	|	printer		|
|	Pick the refrigerator	|	refrigerator		|
|	Pick the ring	|	ring		|
|	Pick the scissors	|	scissors		|
|	Pick the shoe	|	shoe		|
|	Pick the sock	|	sock		|
|	Pick the spaceship	|	spaceship		|
|	Pick the trophy	|	trophy		|
|	Pick the watermelon	|	watermelon		|
|	Pick the wristwatch	|	wristwatch		|
|	numericalmatch	|	mask_match		|
...
|	Pick the penguins-icon	|	penguins-icon		|
|	Pick the lock	|	lock		|
|	Pick the helicopter	|	helicopter		|
|	Pick the guitar	|	guitar		|
|	Pick the controller	|	controller		|
...
|	Pick the image with 3 circles in a row in any direction	|	knots_crosses_circle		|
|	Pick the image with 3 crosses in a row in any direction	|	knots_crosses_knot		|
