public string GetImgInstructions_By_CaptCha69_Com(string CauHoiFullText)
{
	...
	else if(CauHoiFullText.Contains("press the arrows to see different images  when the image matches the example on the left, press submit!")){return "mask_match";}
	return "ident";
}
