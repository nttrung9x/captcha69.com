public string GetImgInstructions_By_CaptCha69_Com(string CauHoiFullText)
{
	...
	else if(CauHoiFullText.Contains("brick cone checker cube")){return "mat_brickcone_checkercube";}
	else if(CauHoiFullText.Contains("brick cone checker sphere")){return "mat_brickcone_checkersphere";}
	else if(CauHoiFullText.Contains("brick cone stripe cone")){return "mat_brickcone_stripecone";}
	else if(CauHoiFullText.Contains("brick cube stripe heart")){return "mat_brickcube_stripeheart";}
	else if(CauHoiFullText.Contains("brick cube stripe sphere")){return "mat_brickcube_stripesphere";}
	else if(CauHoiFullText.Contains("brick heart stripe heart")){return "mat_brickheart_stripeheart";}
	else if(CauHoiFullText.Contains("brick sphere checker heart")){return "mat_bricksphere_checkerheart";}
	else if(CauHoiFullText.Contains("checker cone checker sphere")){return "mat_checkercone_checkersphere";}
	else if(CauHoiFullText.Contains("fuzz cone brick sphere")){return "mat_fuzzcone_bricksphere";}
	else if(CauHoiFullText.Contains("fuzz cube checker cube")){return "mat_fuzzcube_checkercube";}
	else if(CauHoiFullText.Contains("fuzz cube stripe cube")){return "mat_fuzzcube_stripecube";}
	else if(CauHoiFullText.Contains("fuzz heart brick heart")){return "mat_fuzzheart_brickheart";}
	else if(CauHoiFullText.Contains("fuzz heart stripe heart")){return "mat_fuzzheart_stripeheart";}
	else if(CauHoiFullText.Contains("fuzz sphere stripe cone")){return "mat_fuzzsphere_stripecone";}
	else if(CauHoiFullText.Contains("fuzz sphere stripe cube")){return "mat_fuzzsphere_stripecube";}
	else if(CauHoiFullText.Contains("stripe cone checker cube")){return "mat_stripecone_checkercube";}
	else if(CauHoiFullText.Contains("stripe cube checker cube")){return "mat_stripecube_checkercube";}
	else if(CauHoiFullText.Contains("stripe cube checker heart")){return "mat_stripecube_checkerheart";}
	else if(CauHoiFullText.Contains("stripe cube checker sphere")){return "mat_stripecube_checkersphere";}
	else if(CauHoiFullText.Contains("stripe heart checker cube")){return "mat_stripeheart_checkercube";}
	else if(CauHoiFullText.Contains("stripe shape checker shape")){return "mat_stripeshape_checkershape";}
	else if(CauHoiFullText.Contains("stripe shape stripe shape")){return "mat_stripeshape_stripeshape";}
